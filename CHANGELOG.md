...
## [0.3.0](https://github.com/s-yanev/aionrs/compare/v0.2.5...v0.3.0) (2026-07-17)


### ⚠ BREAKING CHANGES

* **cli:** restructure management flags into subcommands ([#184](https://github.com/s-yanev/aionrs/issues/184))

### Features

* accept optional session ID in SessionManager::create and AgentEngine::init_session ([b5e50e8](https://github.com/s-yanev/aionrs/commit/b5e50e82ad8420cf603b3689ea4faba47df988b9))
* add --config-path flag and warn on config parse failure ([2f67ed8](https://github.com/s-yanev/aionrs/commit/2f67ed8bff7d1b585a74e112c39f86ebb9a7fba8))
* add --session-id flag and --resume support in json-stream mode ([6ecfa09](https://github.com/s-yanev/aionrs/commit/6ecfa094042c2cf1966758a105c7fd76db167516))
* add --version flag support for AionUi integration ([0d32f1f](https://github.com/s-yanev/aionrs/commit/0d32f1f21e72ac219eab638c4ca9e2391dd9f42b))
* add AgentBootstrap builder for consistent engine initialization ([#73](https://github.com/s-yanev/aionrs/issues/73)) ([a9392ba](https://github.com/s-yanev/aionrs/commit/a9392ba353d664c0c8429ea1e7a754e493e9ff29))
* add image content block support for Aion CLI ([e362e0a](https://github.com/s-yanev/aionrs/commit/e362e0a6eb57ff39b190077c49c1a808361754d7))
* add image content block support for Aion CLI ([e842e5f](https://github.com/s-yanev/aionrs/commit/e842e5f21cf656bb5a2597bd870d3ad9ee280369))
* add output compaction for tool results ([#54](https://github.com/s-yanev/aionrs/issues/54)) ([63130c7](https://github.com/s-yanev/aionrs/commit/63130c70ead6dc30fb5244e49515bddc767c3c66))
* add ping/pong heartbeat protocol support ([#68](https://github.com/s-yanev/aionrs/issues/68)) ([20e760b](https://github.com/s-yanev/aionrs/commit/20e760b5020525260c5fc10f7211390d96a1be01))
* add ProviderCompat configuration layer (Phase 0.1) ([cc4a315](https://github.com/s-yanev/aionrs/commit/cc4a31547283c9cfae1d7c279784e4a2a2e4ffd5))
* add session_id field to Ready protocol event ([f1025b5](https://github.com/s-yanev/aionrs/commit/f1025b567dddfd8d92e1afa40ab31fd438a85485))
* agent evolution - memory, compaction, plan mode, tool enhancement & file cache ([#32](https://github.com/s-yanev/aionrs/issues/32)) ([0b2a486](https://github.com/s-yanev/aionrs/commit/0b2a486e4e921d3b005307675c102a68d4b8f7ed))
* **agent:** route images through capability-aware view tool ([3c28b34](https://github.com/s-yanev/aionrs/commit/3c28b3457e175fd331df37512c6d78f02f84b83e))
* align maxTurns logic with Claude Code ([#66](https://github.com/s-yanev/aionrs/issues/66)) ([d640d88](https://github.com/s-yanev/aionrs/commit/d640d88380c7c2e64be1c644e1cf424a1699b8a1))
* Bedrock schema sanitization via compat config (Phase 1.4) ([7802f19](https://github.com/s-yanev/aionrs/commit/7802f19709f015f1851a14943a1c2b71d1771f07))
* **cli:** add team mode support with dynamic MCP server injection ([#50](https://github.com/s-yanev/aionrs/issues/50)) ([a16c9ee](https://github.com/s-yanev/aionrs/commit/a16c9eed2d64e679f23f18347fc02c423532298b))
* **compact:** add autocompact_threshold_pct config option ([#95](https://github.com/s-yanev/aionrs/issues/95)) ([58d65a6](https://github.com/s-yanev/aionrs/commit/58d65a6d5c6acb75dceec1ca0d562db8c75166e4))
* compat-driven message alternation, merging, and auto tool ID (Phase 1.1, 1.8) ([9bd5b3c](https://github.com/s-yanev/aionrs/commit/9bd5b3c692bafdd284a8179b6b29647c2bea381a))
* **compat:** add configurable api_path for chat completions endpoint ([ad8b6e9](https://github.com/s-yanev/aionrs/commit/ad8b6e949da7393dfa0d5cecf75449edeba98dbf))
* **config:** add project_dir to CliArgs for non-CWD config loading ([#87](https://github.com/s-yanev/aionrs/issues/87)) ([f0a5fd7](https://github.com/s-yanev/aionrs/commit/f0a5fd7be8582675357ab7994fce96ff4c472004))
* enhanced Bedrock error messages with actionable hints (Phase 2.1) ([a80d0ff](https://github.com/s-yanev/aionrs/commit/a80d0ff03e7c3a3559dc446d21a401b815460e89))
* hierarchical AGENTS.md loading with [@include](https://github.com/include) support ([#59](https://github.com/s-yanev/aionrs/issues/59)) ([3992d52](https://github.com/s-yanev/aionrs/commit/3992d5211b87069f11420fc8c7eaa4e8dc0b8214))
* initial commit of aionrs ([f8f3249](https://github.com/s-yanev/aionrs/commit/f8f3249acfcf595a2634d4ba37ae14993d365246))
* input token optimization — deferred tools, description truncation, prompt caching ([#41](https://github.com/s-yanev/aionrs/issues/41)) ([b20ce58](https://github.com/s-yanev/aionrs/commit/b20ce5813c94fa8c6a682ae8d88c7f17f42ec05a))
* integrate ProviderCompat into config system (Phase 0.2) ([c0a4753](https://github.com/s-yanev/aionrs/commit/c0a47539eab824aea6c823455df3eafbef6f7016))
* OpenAI compat features - max_tokens field, message merging, orphan cleanup, dedup, strip patterns (Phase 1.2, 1.3, 1.5, 1.6, 1.7) ([c61896d](https://github.com/s-yanev/aionrs/commit/c61896d367abbfc31c64a5ae827599a5eee4e558))
* OpenAI reasoning model support (Phase 3.1) ([106108a](https://github.com/s-yanev/aionrs/commit/106108a46c06398c3f68d803a8528fad3b43b8d0))
* pass ProviderCompat to all providers (Phase 0.3) ([d9c6e1b](https://github.com/s-yanev/aionrs/commit/d9c6e1b0901732666b4fa96b747fe5af53929a99))
* **providers:** preserve response body on 429 rate-limit errors ([52aade8](https://github.com/s-yanev/aionrs/commit/52aade888d5916db563d66beda3a5a5b68b05e7b))
* **providers:** preserve response body on 429 rate-limit errors ([f2a2fb1](https://github.com/s-yanev/aionrs/commit/f2a2fb1e36ffb953e4c5f286f22aa5a2f6ed2100))
* runtime config and capability discovery ([#36](https://github.com/s-yanev/aionrs/issues/36)) ([9539b54](https://github.com/s-yanev/aionrs/commit/9539b540c64f30ce6afcbfef65a078ab88913f50))
* session ID and resume support for JSON stream mode ([d36df5e](https://github.com/s-yanev/aionrs/commit/d36df5ed80855ba2fa2fc900a6bee2deda856869))
* skills system - named prompt snippets with tool orchestration ([#5](https://github.com/s-yanev/aionrs/issues/5)) ([4a5183f](https://github.com/s-yanev/aionrs/commit/4a5183fc7657ad756e751986f8c5c471346642cb))
* slash command system with engine-layer interception ([#97](https://github.com/s-yanev/aionrs/issues/97)) ([45859c5](https://github.com/s-yanev/aionrs/commit/45859c5fcd7b89db8c9399ece1bf64e66879cabd))
* structured tracing-based logging system ([#96](https://github.com/s-yanev/aionrs/issues/96)) ([f568afd](https://github.com/s-yanev/aionrs/commit/f568afd30f77159a9b039963bf151bd9572ea18e))
* support custom provider aliases in configuration ([#2](https://github.com/s-yanev/aionrs/issues/2)) ([9fde728](https://github.com/s-yanev/aionrs/commit/9fde728f588ae0233179038984551c016d50919d))
* support parallel persisted sessions ([#195](https://github.com/s-yanev/aionrs/issues/195)) ([5e0f0b5](https://github.com/s-yanev/aionrs/commit/5e0f0b57a2db4f88fa6ff00457633fbc40316547))
* wire up skills system in main.rs and fix symlink traversal ([f93303c](https://github.com/s-yanev/aionrs/commit/f93303c9978fce867ee5361b97ee5fb4a4e2e31f))


### Bug Fixes

* **agent:** enforce runtime tool policies ([c504789](https://github.com/s-yanev/aionrs/commit/c504789c5ab6bcaf8ad725ac87a0adedc25a4c1e))
* **agent:** enforce runtime tool policies ([609e6e5](https://github.com/s-yanev/aionrs/commit/609e6e592700a67657d79067992753ea5dceb8ff))
* **agent:** fingerprint tool-call failure breaker ([299853b](https://github.com/s-yanev/aionrs/commit/299853b348c0f3146369afff48fe9af7ace55ba4))
* **agent:** fingerprint tool-call failure breaker ([5d86fe5](https://github.com/s-yanev/aionrs/commit/5d86fe51e4ecf2149f951ef29f3cd39d268741fd))
* **agent:** harden image input handling ([d8905c0](https://github.com/s-yanev/aionrs/commit/d8905c0b9a2f9c5d97804426d7bba820d50a6b29))
* **agent:** inherit tool policy in sub-agents ([6626b61](https://github.com/s-yanev/aionrs/commit/6626b61a8b5c43feac8b43ce47423a84614efec3))
* **agent:** release pending tool-use abort handling ([#113](https://github.com/s-yanev/aionrs/issues/113)) ([415bd5c](https://github.com/s-yanev/aionrs/commit/415bd5ce9329124702b0010eefe8786cc3bf5b4c))
* **agent:** report cache full miss as info ([#166](https://github.com/s-yanev/aionrs/issues/166)) ([9ffe4d1](https://github.com/s-yanev/aionrs/commit/9ffe4d1aa5c2f2aa0f7b4601317e006f6e1d8a14))
* **agent:** scope tool search to runtime policy ([29ba1ab](https://github.com/s-yanev/aionrs/commit/29ba1ab511aec2e2ccff3236a0014a726fe26120))
* **agent:** structured content entry point and image validation ([537cfae](https://github.com/s-yanev/aionrs/commit/537cfaef4c7f4fbd30548dc6a3d11fc1ffd07884))
* **aion-agent:** guard non-final turns (AIO-24/AIO-62) ([#141](https://github.com/s-yanev/aionrs/issues/141)) ([e49d298](https://github.com/s-yanev/aionrs/commit/e49d298fa699db1c98f10b2f3a95eb98bade4891))
* **aionrs:** add platform context regressions ([#133](https://github.com/s-yanev/aionrs/issues/133)) ([b085171](https://github.com/s-yanev/aionrs/commit/b08517171bb86616b84431f485d7e142722d3795))
* **aionrs:** preserve exec output on timeout ([#143](https://github.com/s-yanev/aionrs/issues/143)) ([9635f2d](https://github.com/s-yanev/aionrs/commit/9635f2da49ac2a35a0d9cb08fc55a01422d13c76))
* **ci:** fix action versions and install cargo-audit ([#10](https://github.com/s-yanev/aionrs/issues/10)) ([8512765](https://github.com/s-yanev/aionrs/commit/85127654ce7afc4ec04b7e6a325d8470e0770175))
* **ci:** fix invalid workflow files (matrix.if + YAML syntax) ([#6](https://github.com/s-yanev/aionrs/issues/6)) ([4fd6de4](https://github.com/s-yanev/aionrs/commit/4fd6de49ad063d5e747b9fcff05d0f29b5535df3))
* **ci:** fix release workflow to correctly build and upload GitHub Release assets ([#12](https://github.com/s-yanev/aionrs/issues/12)) ([997ec18](https://github.com/s-yanev/aionrs/commit/997ec18cbbd21ea2ef8eb19ff4cbf6280376a80c))
* **ci:** fix release_created typo and update Cargo.lock ([#18](https://github.com/s-yanev/aionrs/issues/18)) ([3964963](https://github.com/s-yanev/aionrs/commit/3964963f2d45849985c93e5f005cf59e6615573e))
* **ci:** handle scoped release commit message in release-please workflow ([#22](https://github.com/s-yanev/aionrs/issues/22)) ([7222806](https://github.com/s-yanev/aionrs/commit/72228064a58d9a8ee410d37ad2380c8f84361cc9))
* **cli:** declare direct aion-types dependency ([43ddbf7](https://github.com/s-yanev/aionrs/commit/43ddbf741774efaa35f503736dacf79c5b4fb014))
* **compact:** autocompact token watermark for prefix-caching providers ([#84](https://github.com/s-yanev/aionrs/issues/84)) ([581f11d](https://github.com/s-yanev/aionrs/commit/581f11d0c7e72c04bfd93dac711ded6e7daf89dc))
* **config:** leave max turns unlimited by default ([#159](https://github.com/s-yanev/aionrs/issues/159)) ([e351951](https://github.com/s-yanev/aionrs/commit/e351951a151235c672bfee71460822e5d00d7d42))
* cross-platform shell execution for Windows support ([#70](https://github.com/s-yanev/aionrs/issues/70)) ([402d4ff](https://github.com/s-yanev/aionrs/commit/402d4ff7311ec47892733dfb79dcd9e83fbfce9c))
* **deps:** resolve rustls-webpki security vulnerabilities ([#90](https://github.com/s-yanev/aionrs/issues/90)) ([b2f46b3](https://github.com/s-yanev/aionrs/commit/b2f46b3c7d3463499381b75ac82c5cbb53fb44e9))
* **deps:** update rust crate getrandom to 0.4 ([c78cbcf](https://github.com/s-yanev/aionrs/commit/c78cbcf8ac94d7b523e23a0b0f34d21b3fbbaaa8))
* **deps:** update rust crate getrandom to 0.4 ([37666d3](https://github.com/s-yanev/aionrs/commit/37666d3379273fc599633610f63c83d249806a5b))
* **deps:** update rust crate getrandom to 0.4 ([#188](https://github.com/s-yanev/aionrs/issues/188)) ([e8f1a7d](https://github.com/s-yanev/aionrs/commit/e8f1a7dfa84c99d83b469dd6970ba2609ffbc10a))
* **deps:** update rust crate getrandom to 0.4 ([#193](https://github.com/s-yanev/aionrs/issues/193)) ([2a02775](https://github.com/s-yanev/aionrs/commit/2a027756269ffbf8328a3cf5906356482f8966fa))
* honor compat max token defaults ([77029c3](https://github.com/s-yanev/aionrs/commit/77029c396be5f666fa3f782235af86e676e303ed))
* inject workspace cwd into tools and hooks ([#110](https://github.com/s-yanev/aionrs/issues/110)) ([6ef52cc](https://github.com/s-yanev/aionrs/commit/6ef52ccd81df6af3760931b63f8c1c8c92fc590a))
* isolate sub-agent stdout to prevent JSON stream corruption ([#34](https://github.com/s-yanev/aionrs/issues/34)) ([6a7584a](https://github.com/s-yanev/aionrs/commit/6a7584abe9d0f5c85c36c01858d503cc72d9facd))
* make max tokens optional by provider ([6f2f8ad](https://github.com/s-yanev/aionrs/commit/6f2f8adb9fbb5f20af95710ba42d3ade4333a085))
* **mcp:** connect servers concurrently during startup ([#126](https://github.com/s-yanev/aionrs/issues/126)) ([3791041](https://github.com/s-yanev/aionrs/commit/3791041d72e5ee55d136f42ba05e7a18bcd55768))
* **mcp:** tolerate CRLF line endings in SSE responses ([#134](https://github.com/s-yanev/aionrs/issues/134)) ([dcec839](https://github.com/s-yanev/aionrs/commit/dcec8394757e88c82f8854e1df1628ba211e924f))
* **openai:** handle empty function name in SSE deltas + add response dump ([#43](https://github.com/s-yanev/aionrs/issues/43)) ([d7ba0fa](https://github.com/s-yanev/aionrs/commit/d7ba0fabe48ea2a19cff42d8764ca5ccc1a3d608))
* **openai:** preserve reasoning_content in multi-turn conversations ([#80](https://github.com/s-yanev/aionrs/issues/80)) ([88bdf06](https://github.com/s-yanev/aionrs/commit/88bdf061883043a50a21d25e241a4e6eee9623da))
* **orchestration:** guide LLM to ToolSearch when deferred tool fails ([#60](https://github.com/s-yanev/aionrs/issues/60)) ([a62c8c2](https://github.com/s-yanev/aionrs/commit/a62c8c249e45bc56e5bc74bf74f29d43311ede2c))
* preserve Anthropic thinking signatures ([#117](https://github.com/s-yanev/aionrs/issues/117)) ([07f6c14](https://github.com/s-yanev/aionrs/commit/07f6c149cd526e87a9dc410fd964b050f05120c5))
* **providers:** add OpenAI field policy controls ([bce81bb](https://github.com/s-yanev/aionrs/commit/bce81bb2cd578d84a89bba50c5de5ee0523a9b42))
* **providers:** add projection preflight limits ([270dc4c](https://github.com/s-yanev/aionrs/commit/270dc4c43c03a9e2103efa97839b7423a99ffe96))
* **providers:** add tool wire shape controls ([eeded83](https://github.com/s-yanev/aionrs/commit/eeded838183c2e3dff59f761cd3731f6a60e8586))
* **providers:** auto-generate tool call ID for OpenAI-compatible providers ([#99](https://github.com/s-yanev/aionrs/issues/99)) ([06fc04a](https://github.com/s-yanev/aionrs/commit/06fc04ae1fb74e8633d92e5b5e5683f6bac06fec))
* **providers:** Gemini tool call compatibility ([#93](https://github.com/s-yanev/aionrs/issues/93)) ([c70c020](https://github.com/s-yanev/aionrs/commit/c70c020461ccac2e7349459f159b535fe6224029))
* **providers:** legalize tool schemas ([c6d637c](https://github.com/s-yanev/aionrs/commit/c6d637ce51d21c3ce0e8019a4a77d5005c8f3e90))
* **providers:** retry initial provider 5xx responses ([618f3ee](https://github.com/s-yanev/aionrs/commit/618f3eecb1a81aab04c5cc5ae62c091e9b0a2fd4))
* **providers:** retry initial provider 5xx responses ([9c9b7ec](https://github.com/s-yanev/aionrs/commit/9c9b7ec2612d12498bdbf0d7e92c9513694d85ed))
* **providers:** retry SSE stream on mid-stream connection disconnect ([#101](https://github.com/s-yanev/aionrs/issues/101)) ([af34593](https://github.com/s-yanev/aionrs/commit/af34593a2b43de70d9cc41f6ec156d4b5b1fffc8))
* **providers:** sanitize malformed tool calls ([#132](https://github.com/s-yanev/aionrs/issues/132)) ([c689d76](https://github.com/s-yanev/aionrs/commit/c689d768c7c21fb3061a6089337dbefa8338b456))
* **providers:** stop empty reasoning replay ([6e91780](https://github.com/s-yanev/aionrs/commit/6e91780bf8372ccce1a63fe7b8a1bb6bec3950cf))
* **provider:** support OpenAI-compatible thinking and chat paths ([#203](https://github.com/s-yanev/aionrs/issues/203)) ([6a05d5a](https://github.com/s-yanev/aionrs/commit/6a05d5adfc3c106b8704d410c64acda3043d663d))
* **release:** bootstrap release-please for Cargo workspace ([#8](https://github.com/s-yanev/aionrs/issues/8)) ([18dd3e3](https://github.com/s-yanev/aionrs/commit/18dd3e32213ffabe022f05eaa9b16ec89ad04a76))
* remove duplicate aws smithy lock entry ([f807a15](https://github.com/s-yanev/aionrs/commit/f807a157174e7f5d7c3d30409ee7132bb2cfdee0))
* remove redundant compat default update ([b3ec51f](https://github.com/s-yanev/aionrs/commit/b3ec51fe7f8e98b3e29b18219b5c895a7bf3e22d))
* **shell:** preserve Windows command stdout ([8215d3c](https://github.com/s-yanev/aionrs/commit/8215d3c28bb40ce99abd8966cd90d48f69bfe5c8))
* **shell:** resolve ExecCommand shell semantics ([#123](https://github.com/s-yanev/aionrs/issues/123)) ([3a51c7d](https://github.com/s-yanev/aionrs/commit/3a51c7d07f96388fb100375a166d144360440561))
* **shell:** use runner for hooks and skills ([6c418fd](https://github.com/s-yanev/aionrs/commit/6c418fd175528b9f2c6bdf1e71cb1a6f76d90d38))
* UTF-8 panic in tool describe + autocompact skip logging ([#63](https://github.com/s-yanev/aionrs/issues/63)) ([c00222d](https://github.com/s-yanev/aionrs/commit/c00222d5363c681398dfd1333108ea38fc9eae69))


### Code Refactoring

* centralize platform-specific paths via app_config_dir() ([ad87748](https://github.com/s-yanev/aionrs/commit/ad87748edb299ff488c839630f065ccafc6e28dc))
* **cli:** restructure management flags into subcommands ([#184](https://github.com/s-yanev/aionrs/issues/184)) ([7969fa2](https://github.com/s-yanev/aionrs/commit/7969fa2ff7ef22230e949566ba4192f3bd3070b9))
* extract ProtocolEmitter trait for backend integration ([#75](https://github.com/s-yanev/aionrs/issues/75)) ([b792d74](https://github.com/s-yanev/aionrs/commit/b792d74a0171708de4f6c2019f1b3f3864375b0b))
* organize agent internals ([#164](https://github.com/s-yanev/aionrs/issues/164)) ([b670770](https://github.com/s-yanev/aionrs/commit/b670770f96877147617c9dcab1310940f40e2f23))
* **providers:** compose transports ([#157](https://github.com/s-yanev/aionrs/issues/157)) ([f7089de](https://github.com/s-yanev/aionrs/commit/f7089deb3090bda08a8119d0cd422a64fbae3aac))
* remove Claude branding, use AGENTS.md and AIONRS_* variables ([97dc25c](https://github.com/s-yanev/aionrs/commit/97dc25cabd3f4bc15e34d3a42da5dd42120e3bb2))
* split into Cargo workspace with fine-grained crates + CI/E2E ([#3](https://github.com/s-yanev/aionrs/issues/3)) ([a4537d9](https://github.com/s-yanev/aionrs/commit/a4537d944b3f3643ecb7db58c569f583edea7f97))


### Documentation

* add AGENTS.md with architecture principles and CLAUDE.md reference ([5dfeb89](https://github.com/s-yanev/aionrs/commit/5dfeb8990f6ba59363ad8c51eb3ba7738546f56f))
* add aionrs code standards ([#214](https://github.com/s-yanev/aionrs/issues/214)) ([5d0eae1](https://github.com/s-yanev/aionrs/commit/5d0eae1cc0f5d901d627d16e7247261bebeec500))
* document --session-id flag and session_id in Ready event ([510c141](https://github.com/s-yanev/aionrs/commit/510c141bf93b7a39ba6dda9cef9d9b8a2791f900))
* refactor AGENTS.md to focus on rules and conventions ([0f81cbc](https://github.com/s-yanev/aionrs/commit/0f81cbc644f8c9ed3cbe6af690bc23434feb6c0a))
* replace hardcoded ~/.config/aionrs paths with --config-path ([d94d518](https://github.com/s-yanev/aionrs/commit/d94d518ea12b0360a9f27e440fb7c0e08b0ffe93))
* sync documentation with v0.1.8–v0.1.12 code changes ([#56](https://github.com/s-yanev/aionrs/issues/56)) ([436b09b](https://github.com/s-yanev/aionrs/commit/436b09b5a44997b0fb3b679b31ffe608b9f2ebf9))
* update file paths to reflect multi-crate workspace structure ([51b6cc7](https://github.com/s-yanev/aionrs/commit/51b6cc7bd29a51af7ad57aa8f87901e85005da42))
* update README with ProviderCompat layer and reasoning model support ([c831e21](https://github.com/s-yanev/aionrs/commit/c831e2119804f0e5bb2a080f9bef8c5df093dff3))
